      ...
      <View style={{ marginHorizontal: 24, marginVertical: 40 }}>
        ...
        <View
          ...
          <View
            ...
            <Text style={{ color: '#000000', fontSize: 14, fontWeight: '600' }}>
              Rp {formatIDR(dataBooking.price)}
            </Text>
          </View>
          <View
            style={{
            ...
            <Text
              ...
              {selectedSeat.sort((a, b) => a - b).join(', ')}
            </Text>
          </View>
          ...
          <View
            ...
            <Text style={{ color: '#5F2EEA', fontSize: 22, fontWeight: '600' }}>
              Rp {formatIDR(dataBooking.price * selectedSeat.length)}
            </Text>
          </View>
        </View>
