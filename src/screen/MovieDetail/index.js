    ...
    <ScrollView style={{ backgroundColor: 'white', height: '100%' }}>
      <View style={{ alignItems: 'center', margin: 30 }}>
        <View
          ...
          <Image
            source={{
              uri: `${process.env.REACT_APP_URL_CLOUDINARY}/${movieData.image}`,
            }}
            style={{ width: 160, height: 250, borderRadius: 6 }}
          />
        </View>
      </View>
      ...
      <View style={{ paddingHorizontal: 24 }}>
        ...
        <View style={{ flexDirection: 'row' }}>
          <View style={{ flexDirection: 'column' }}>
            <View style={{ marginRight: 80, marginBottom: 20 }}>
              <Text style={{ color: '#8692A6', fontSize: 14 }}>
                Release date
              </Text>
          ...
          <View style={{ flexDirection: 'column' }}>
            ...
            <View>
              ...
              <Text style={{ color: '#121212', fontSize: 16, maxWidth: 150 }}>
                {movieData.casts}
              </Text>
            </View>
          </View>
        ...
        <Text style={{ color: '#8692A6', fontSize: 14, lineHeight: 22 }}>
          {movieData.synopsis}
        </Text>
      </View>
      ...
      <View
        ...
        {schedule.length > 0 ? (
              ...
              <View
                ...
                {item.time.split(',').map((ele, index) => (
                  <TouchableOpacity
                    ...
                    onPress={() => setTime(item.id, index, ele, item.price)}>
                    <Text
                      style={
          ...
          <View>
            <Text>Schedule not available</Text>
          </View>
        )}
      </View>
